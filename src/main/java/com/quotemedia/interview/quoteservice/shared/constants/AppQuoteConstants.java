package com.quotemedia.interview.quoteservice.shared.constants;

public class AppQuoteConstants {

    // Errors Constants
    public static final String ERROR_INVALID_DATE_FORMAT = "error.application.invalid.date.format";
